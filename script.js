const SITE_URL = 'https://theworldbeyond.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'The World Beyond — Sonic Remedy | Soozhee', text: 'The World Beyond by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
